...
describe("normalizeModelSlug", () => {
  it("maps known aliases to canonical slugs", () => {
    ...
    expect(normalizeModelSlug("glm 5.1", "opencode")).toBe("glm-5.1");
    expect(normalizeModelSlug("mimo-v2-omni", "opencode")).toBe("mimo-v2-omni");
  });
...
describe("inferProviderForModel", () => {
  it("detects known provider model slugs", () => {
    ...
    expect(inferProviderForModel("glm-5.1")).toBe("opencode");
    expect(inferProviderForModel("minimax-m2.7")).toBe("opencode");
  });
});
